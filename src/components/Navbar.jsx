...
function MenuList({user, onClick}) {
  ...
  <div>
    <Menu as='div' className='inline-block text-left'>
     <div className="flex">
      <Menu.Button className='inline-flex gap-2 w-full rounded-md md:px-4 py-2 text-sm font-medium text-slate-700 hover:bg-opacity-20 '>
  ...
  return (
    ...
    <div className='relative bg-[#f7fdfd] z-50'>
        <nav className='container mx-auto flex items-center justify-between p-5'>
          ...
          <img src={Logo} alt='JobFinder Logo' className='h-10 w-auto' />
          </Link>
          </div>
